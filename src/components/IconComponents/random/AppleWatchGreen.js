...
const AppleWatchGreen = (props) => (
  <svg viewBox="0 0 18 32" {...props}>
    ...
    />
    <path
      d="M15 6H3a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V9a3 3 0 0 0-3-3z"
      fill="#333"
    />
    <path fill="#4d4d4d" d="M2.01 9.002h13.983v13.995H2.01z" />
    <circle cx={9} cy={16} r={2} fill="#eaf1f6" />
    <circle cx={11} cy={12} r={1} fill="#48a0dc" />
    <circle cx={11} cy={20} r={1} fill="#fc6" />
    <circle cx={13} cy={16} r={1} fill="#88c057" />
    <circle cx={5} cy={16} r={1} fill="#9b7cab" />
